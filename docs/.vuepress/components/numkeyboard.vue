<template>
  <div class="numkeypad-example">
    <h4>数字键盘组件</h4>
    <numkeyboard :options="forms[0]" @touchend.native="showkeyboard(0)">
    </numkeyboard>
    <numkeyboard :options="forms[1]" @touchend.native="showkeyboard(1)">
    </numkeyboard>
    <numkeyboard :options="forms[2]" @touchend.native="showkeyboard(2)">
    </numkeyboard>
